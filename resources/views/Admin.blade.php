...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Admins</b>Medica_Travel</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        @if(auth()->user()->profile)
        	...
        	<img src="{{auth()->user()->profile->URL}}" width="120" height="110" class="img-circle" alt="User Image">
        @else
        <!-- do nothing -->
        @endif
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/hotel"><i class="fa fa-bed"></i> Our Hôtels</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/clinique"><i class="fa fa-h-square"></i> Our Cliniques</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
           <li><a href="/chirurgien"><i class="fa fa-stethoscope"></i> Our Chirurgien</a></li>
            <li><a href="/chirurgien/create"><i class="fa fa-plus"></i> Add</a></li> 
            <li><a href="/specialite"><i class="fa fa-ravelry"></i> Specialites</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="/hotel"><i class="fa fa-dashboard"></i> Home</a></li>
